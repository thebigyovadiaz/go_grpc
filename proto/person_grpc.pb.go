...
type PersonServiceClient interface {
	...
	Read(ctx context.Context, in *SinglePersonResponse, opts ...grpc.CallOption) (*PersonProfileResponse, error)
	Update(ctx context.Context, in *UpdatePersonRequest, opts ...grpc.CallOption) (*SuccessResponse, error)
	Delete(ctx context.Context, in *SinglePersonResponse, opts ...grpc.CallOption) (*SuccessResponse, error)
}
...
func (c *personServiceClient) Read(ctx context.Context, in *SinglePersonResponse, opts ...grpc.CallOption) (*PersonProfileResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PersonProfileResponse)
...
func (c *personServiceClient) Delete(ctx context.Context, in *SinglePersonResponse, opts ...grpc.CallOption) (*SuccessResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SuccessResponse)
...
type PersonServiceServer interface {
	...
	Read(context.Context, *SinglePersonResponse) (*PersonProfileResponse, error)
	Update(context.Context, *UpdatePersonRequest) (*SuccessResponse, error)
	Delete(context.Context, *SinglePersonResponse) (*SuccessResponse, error)
...
func (UnimplementedPersonServiceServer) Read(context.Context, *SinglePersonResponse) (*PersonProfileResponse, error) {
...
func (UnimplementedPersonServiceServer) Delete(context.Context, *SinglePersonResponse) (*SuccessResponse, error) {
...
func _PersonService_Read_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PersonServiceServer).Read(ctx, req.(*SinglePersonResponse))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PersonService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PersonServiceServer).Delete(ctx, req.(*SinglePersonResponse))
	}
	return interceptor(ctx, in, info, handler)
}
